 ...
 * @param encryption {integer} encryption to protect sensitive data for rdp
 */
function X224(transport, encryption) {
	this.transport = transport;
  this.requestedProtocol = this.selectedProtocol = encryption === undefined ? Protocols.PROTOCOL_SSL: encryption;
 ...
 * @param encryption {integer} encryption to protect sensitive data for rdp
 */
function Client(transport, encryption) {
	X224.call(this, transport, encryption);
